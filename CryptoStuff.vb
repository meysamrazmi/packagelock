...
Module Crypto
    ...
    Public password As Byte() = {&H32, &H99, &H98, &H2, &H49, &H2, &H5, &H6, &HF1, &HF0, &H23, &H21, &H22, &H11}
...
#Region "Encrypt Files and Streams"
    ...
    Public Sub EncryptFile(ByVal in_file As String, ByVal out_file As String)
        CryptFile(Encoding.UTF32.GetString(password), in_file, out_file, True)
    End Sub
    Public Sub DecryptFile(ByVal in_file As String, ByVal out_file As String)
        CryptFile(Encoding.UTF32.GetString(password), in_file, out_file, False)
    End Sub
    ...
    Private Sub CryptStream(ByVal password As String, ByVal in_stream As Stream, ByVal out_stream As Stream, ByVal encrypt As Boolean)
